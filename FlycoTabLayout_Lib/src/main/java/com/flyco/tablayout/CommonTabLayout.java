...
public class CommonTabLayout extends HorizontalScrollView implements ValueAnimator.AnimatorUpdateListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mTabMinWidth = ta.getDimension(R.styleable.CommonTabLayout_tl_tab_minwidth,dp2px(0));
        mTabPadding = ta.getDimension(R.styleable.CommonTabLayout_tl_tab_padding, mTabSpaceEqual || mTabWidth > 0 ? dp2px(0) : dp2px(5));
...
//        }
        ...
        int newScrollX = (mTabsContainer.getChildAt(mCurrentTab).getLeft() - getWidth() / 2)>0?mTabsContainer.getChildAt(mCurrentTab).getLeft() - getWidth() / 2:0;
...
//        Log.d("AAA", "mCurrentP--->" + mCurrentP.left + "&" + mCurrentP.right);
    ...
    public void setTabMinWidth(float minWidth){

        this.mTabMinWidth = dp2px(minWidth);
        updateTabStyles();
    }
