...
public class UnScrollTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    public UnScrollTabLayout(Context context) {
        this(context, null, 0);
    }

    public UnScrollTabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public UnScrollTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
